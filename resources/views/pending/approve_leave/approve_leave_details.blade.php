                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12 col-sm-12 col-md-12">
                                <a href="#" id="approve_wp" lv_id="{{ $leave_dtl['lv_id'] }}" empno="{{ $leave_dtl['empno'] }}" class="btn btn-sm btn-success"><small>Approve with Pay</small></a>
                                <a href="#" id="approve_wop" lv_id="{{ $leave_dtl['lv_id'] }}" empno="{{ $leave_dtl['empno'] }}" class="btn btn-sm btn-primary"><small>Approve without Pay</small></a>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-2">
                                                ...
                                                {{-- @if($leave_dtl['status'] == 'Pending') --}}
                                                    ...
                                                    data-no_days="{{ $leave_dtl['app_days'] }}"><small>Edit</small></a>
                                                {{-- @endif --}}
                                            </td>
                                        </tr>
...
$(document).ready(function(){
    $('a#approve_wp').click(function(){
        ...
        $.confirm({
            ...
            type: 'dark',
            icon: 'fa fa-calendar',
            title: '<small>Approve With Pay</small>',
            buttons:{
                confirm: {
                    ...
                    action: function(){
                        $.ajax({
                            ...
                            type: "PATCH",
                            url: '/approve/with_pay/'+lv_id+'/'+empno,
                            success: function(){

                                toastr.success('Leave Approved.');

                                window.location.href = '/approve_leave';
                            },
    ...
    $('a#approve_wop').click(function(){
        ...
        $.confirm({
            ...
            type: 'red',
            icon: 'fa fa-calendar',
            title: '<small>Approve Without Pay</small>',
            buttons:{
                confirm: {
                    btnClass: 'btn-primary',
                    action: function(){
                        $.ajax({
                            ...
                            type: "PATCH",
                            url: '/approve/without_pay/'+lv_id+'/'+empno,
                            success: function(){
