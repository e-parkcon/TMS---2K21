    ...
    <div class="row1">
        @foreach($visitors as $key => $visit)
            @if($key%2)
                <div class="column1">
                    <div class="col-md-12">
                        <small>Health Checklist</small> <small style="color:gray; font-size: 10px;"> [Visitors]</small>
                    </div>
                    <br>
                    ...
                    <table width=100% id="table">
                        ...
                        <tr>
                            <td width=10%><small style="float: left;">Nature of visit</small> <span style="float: right;">:</span></td>
                            <td width=25% style="border-bottom: 1px solid black;"><small style="text-transform: capitalize;">{{ $visit['nature_of_visit'] }}</small></td>
                            <td width=10%><small style="float: left;">Person to visit</small> <span style="float: right;">:</span></td>
                            <td width=10% style="border-bottom: 1px solid black;"><small>{{ $visit['person_to_visit'] }}</small></td>
                        </tr>
                    </table>
                    ...
                    <table width=100% id="table">
                        <tr>
                            <td></td>
                            <td style="text-align: center; border-bottom: 1px solid black; text-transform: uppercase;"><small> {{ $visit['name'] }}</small></td>
                            <td></td>
